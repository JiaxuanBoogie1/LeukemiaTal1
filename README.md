...
## makeCCCA:
This is the main function inside ChipPComp. This function contain sub functions makeAFS (find the alternative feature space), makeUDM (unified all AFS to make unified density matrix), and makePRC (find the principal component analysis) 
...
## motifDistance:
To find the distance between the first and the second motifs inside the genomic ranges. The distances are relative to the start of each motif.
...
## mT1:
This is the main function in mT1 package. mT1 is used to investigate novel preferred motif distance from a large set of motifs and identify composite motifs.
...
This is the REQUIRED parameter for mT1. It is a string of motifs to be compared within the fasta sequencing file. The string of motifs contains the first motif Ebox “CANNTG”, the second motif GATA “GATAA” and a list of motifs inside Jaspar database as common Tal1 binding motifs. The novel preferred distances among all these motifs are compared with each other.
